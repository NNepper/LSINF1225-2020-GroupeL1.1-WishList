...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    protected static final String[] Populate = new String[]{
            ...
            "INSERT INTO Products (productID, name, description, link, purchased, position, quantity, wishlistID, rating) VALUES (4, 'Name', 'Description', 'https://www.ecosia.org/search?q=weblink', 0, 1, 1, -10, 0);\n",
            "INSERT INTO Products (productID, name, description, link, purchased, position, quantity, wishlistID, rating) VALUES (5, 'Football shirt', 'Football shirt of Axel Witsel with Belgian Red Devils', 'https://www.belgoshop.com/en/shirt-belgian-red-devils-euro-2020-home.html?id=211117860', 0, 1, 1, 1, 0);\n",
            "INSERT INTO Products (productID, name, description, link, purchased, position, quantity, wishlistID, rating) VALUES (6, 'Tennis raquet', 'A babolat tennis raquet of size 3', 'https://www.babolat.fr/product/tennis/racket/pure-drive-101334', 0, 2, 1, 1, 0);\n",
            "INSERT INTO Products (productID, name, description, link, purchased, position, quantity, wishlistID, rating) VALUES (7, 'Football ball', 'The original Jabulani ball from South Africa World Cup 2008', 'I cannot find one!', 0, 3, 1, 1, 0);\n",
            "INSERT INTO Products (productID, name, description, link, purchased, position, quantity, wishlistID, rating) VALUES (8, 'Football shoes', 'This new shoes are so insane!', 'https://www.nike.com/be/fr/u/phantom-vision-academy-id-45007/701417220', 0, 4, 1, 1, 0);\n",
            ...
            "INSERT INTO Products (productID, name, description, link, purchased, position, quantity, wishlistID, rating) VALUES (16, 'Meat slicer', 'This is a meat slicer to slice my sausage', 'https://www.amazon.com/XYQC-Trancheuse-Saucisson-Waterproof-Meat-Cutter/dp/B0814S5RL6/ref=sr_1_1?crid=1SSUJHG701O5H&dchild=1&keywords=trancheuse+saucisson&qid=1588953282&sprefix=trancheuse+%2Caps%2C274&sr=8-1', 0, 4, 1, 3, 0);\n",
            "INSERT INTO Products (productID, name, description, link, purchased, position, quantity, wishlistID, rating) VALUES (17, 'Sunglasses', 'Red sunglasses', 'https://www.amazon.com/ShadyVEU-Colorful-Lennon-Groovy-Sunglasses/dp/B0757GQ478/ref=sr_1_2?dchild=1&keywords=red+sunglasses&qid=1588953310&sr=8-2', 0, 1, 1, 4, 0);\n",
            "INSERT INTO Products (productID, name, description, link, purchased, position, quantity, wishlistID, rating) VALUES (18, 'Coat', 'Brown wool coat from Ireland', 'https://www.stories.com/en_eur/clothing/jackets-coats/woolcoats/product.oversized-belted-wool-coat-brown.0773784002.html', 0, 2, 1, 4, 0);\n",
            "INSERT INTO Products (productID, name, description, link, purchased, position, quantity, wishlistID, rating) VALUES (19, 'Controller', 'PC controller to play with my friends', 'https://www.xbox.com/en-US/accessories/controllers/red-wireless-controller', 0, 3, 1, 4, 0);\n",
            "INSERT INTO Products (productID, name, description, link, purchased, position, quantity, wishlistID, rating) VALUES (20, 'Magnet', 'A true scientific magnet', 'https://www.amazon.com/Neodymium-Countersunk-Diameter-Retrieving-Magnetic/dp/B074BTSR1L/ref=sxin_7_ac_d_rm?ac_md=1-1-bGFyZ2UgbWFnbmV0-ac_d_rm&cv_ct_cx=magnet&dchild=1&keywords=magnet&pd_rd_i=B074BTSR1L&pd_rd_r=2c575085-6b68-4886-94bc-d4034eb56e49&pd_rd_w=Mpo16&pd_rd_wg=pWcuS&pf_rd_p=165462b8-b004-445b-8c70-cf9e9e805494&pf_rd_r=QBYS1HWKSZNFF41J051K&psc=1&qid=1588953431&sr=1-2-12d4272d-8adb-4121-8624-135149aa9081', 0, 4, 1, 4, 0);\n",
