...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    protected static final String[] Populate = new String[]{
            ...
            "INSERT INTO User (userID, firstname, lastname, username, email, password, address, fav_color, shoe_size, trouser_size, tshirt_size, privacy) VALUES (2, 'Bruce', 'lingier', 'blingier', 'corentin', 'password', 'Place des Wallons 70, 1348 Louvain-la-Neuve', 'rouge', 42, 'M', 'M', 0);\n",
